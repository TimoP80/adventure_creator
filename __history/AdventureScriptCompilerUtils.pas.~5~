...
procedure SaveScriptToAGF(var f: file; TheScript: Script; filename: string);
procedure LoadScriptFromAGF(var f: file; TheScript: Script; filename: string);
...
begin
  ...
  built_in_functions.add('RandomNumber');
